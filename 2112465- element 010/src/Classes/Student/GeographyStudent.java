...
public class GeographyStudent extends Student {
    ...
    public GeographyStudent(String lastName, String firstName, String studentYear,int[] marks) {
    ...
    public String toString() {
        return "GeographyStudent: " + getFirstName() + " " + getLastName() + ": Overall: " + getFinalResult() +
                " {" +
